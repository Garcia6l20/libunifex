...
#include <unifex/net/ipv4_endpoint.hpp>
...
std::string unifex::net::ipv4_endpoint::to_string() const {
...
std::optional<unifex::net::ipv4_endpoint>
unifex::net::ipv4_endpoint::from_string(std::string_view string) noexcept {
